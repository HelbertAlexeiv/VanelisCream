    ...
    <footer className="store-footer" id="store-footer">
      <div className="footer-inner">
        <div className="footer-item">
          <span className="footer-label">Ubicación:</span> UIS
        </div>
        <div className="footer-divider" />
        <div className="footer-item">
          <span className="footer-label">Horarios:</span> Lunes - Viernes  8am - 5pm
        </div>
        <div className="footer-divider" />
        <div className="footer-item footer-social">
          ...
          <div className="social-icons">
            ...
            <span className="social-name">Vanelis Cream</span>
          </div>
        </div>
      </div>
    </footer>
