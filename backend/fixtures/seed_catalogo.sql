...
-- Ajuste compatible con el modelo Django (URLField max_length=500)
...
-- Registros que se eliminaron del set final
...
-- Upsert de productos sin depender de IDs fijos
WITH data (nombre, descripcion, precio, imagen, stock, marca_nombre, presentacion_nombre) AS (
    VALUES
    ('Paleta Aloha Limón', 'Paleta sabor limón', 2000.00, 'https://www.tiendacremhelado.com.co/p/paleta-aloha-limon/', 50, 'Crem Helado', 'Paleta'),
    ('Paleta Aloha Mango biche', 'Paleta sabor mango biche', 3000.00, 'https://www.tiendacremhelado.com.co/p/paleta-aloha-mango-biche/', 50, 'Crem Helado', 'Paleta'),
    ...
    ('Paleta Polet Chocoavellana', 'Paleta sabor chocoavellana', 7000.00, 'https://www.tiendacremhelado.com.co/p/paleta-polet-chocoavellana/', 50, 'Crem Helado', 'Paleta'),
    ...
    ('Cono Bocatto Tres Leches', 'Cono sabor tres leches', 5700.00, 'https://www.tiendacremhelado.com.co/p/cono-bocatto-tres-leches/', 50, 'Crem Helado', 'Cono'),
    ...
    ('Cono CHOCOCONO CHOCOKRISPIS', 'Cono con chocokrispis', 4500.00, 'https://www.tiendacremhelado.com.co/p/cono-chococono-chocokrispis/', 50, 'Crem Helado', 'Cono'),
    ('Cono CHOCOCONO FLOW', 'Cono flow', 4000.00, 'https://www.tiendacremhelado.com.co/p/cono-chococono-flow/', 50, 'Crem Helado', 'Cono'),
    ('Cono CHOCOCONO MINI', 'Cono mini', 2500.00, 'https://www.tiendacremhelado.com.co/p/cono-chococono-mini/', 50, 'Crem Helado', 'Cono'),
    ('Galleta con Helado Arequipe', 'Galleta con helado sabor arequipe', 3500.00, 'https://www.tiendacremhelado.com.co/p/galleta-con-helado-arequipe/', 50, 'Crem Helado', 'Galleta'),
    ...
    ('Tarrina Ron con Pasas', 'Tarrina sabor ron con pasas', 39900.00, 'https://www.megatiendas.co/helado-popsy-ron-con-pasas-x-60-g-7705890993502/p?srsltid=AfmBOoq0G1bPlT0jiCtVQcUyZDRUEhyydBxtxygqmMoP1_2NMqh7RgQ_', 50, 'Popsy', 'Tarrina'),
    ('Tarrina Arequipe Gourmet', 'Tarrina gourmet sabor arequipe', 39900.00, 'https://www.heladospopsy.com/', 50, 'Popsy', 'Tarrina'),
    ...
    ('Litro Arequipe Gourmet', 'Helado litro sabor arequipe', 39900.00, 'https://www.facebook.com/HeladosPopsy/photos/cu%C3%A1l-es-tu-momento-perfecto-para-un-litro-de-helado-nunca-es-muy-temprano-o-muy-/5190243924373215/', 50, 'Popsy', 'Litro'),
